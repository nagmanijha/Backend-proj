...
// dev, you have to decide how much you want to allow users 
                ...
                $lookup: {
                    ...
                    pipeline: [
                        ...
                        },
                        {
                            $addFields: {
                                owner: { 
                                    $arrayElemAt: ["$owner", 0] // owner is an array, we need first element, 
                                 }
                            }
                        }
                    ]
...
// in plc, we update file separately in middleware
export {
    registerUser,
    loginUser,
    logoutUser,
